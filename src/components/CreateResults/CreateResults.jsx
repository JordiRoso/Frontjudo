...
function CreateResults() {
  ...
  <form onSubmit={handleSubmit}>
    ...
    <div className="form-group">
      ...
      <select className="form-control" id="weight" value={weight} onChange={handleWeightChange}>
        {isMenCompetition ? (
          <>
    ...
    <select className="form-control" id="position" value={position} onChange={handlePositionChange}>
...
<div className="form-group">
    ...
    <input type="text" className="form-control" id="nameComp" value={nameComp} onChange={handleNameCompChange} />
</div>

<div className="form-group">
    <label htmlFor="club">Club:</label>
    <input type="text" className="form-control" id="club" value={club} onChange={handleClubChange} />
</div>

<div className="form-group">
    <button type="submit" className="btn btn-primary">Crear Competicion</button>
</div>
</form>
    </div>
      );
