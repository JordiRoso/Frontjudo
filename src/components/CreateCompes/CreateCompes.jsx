...
function CreateCompes() {
  ...
  //   try {
  //     console.log(data);
  //     await ResultsService.updateCompetition(data);
  ...
  //   const competitionIndex = e.target.value;
  //   const selectedCompetitionID = competitions[competitionIndex]._id;
  //   console.log("Selected competition ID:", selectedCompetitionID);
  //   setCompetitionId(selectedCompetitionID);
  //   setCompetitionId(competitions[competitionIndex].id);
  // };
  const handleCompetitionChange = (e) => {
        ...
        {/* <div>
          ...
          >
            {competitions.map((competition, index) => (
              <option key={competition.id} value={index} data-competition-id={competition._id}>
        ...
        {/* <div>
          ...
          >
            {competitions.map((competition) => (
              <option key={competition.id} value={competition._id}>
                {competition.name} ({competition.category} - {competition.year}{" "}
                - {competition.gender})
              </option>
            ))}
